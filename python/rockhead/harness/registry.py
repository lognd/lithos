...
:data:`rockhead.harness.MODEL_REGISTRY_VERSION`, and that string is folded
into every evidence hash (via :mod:`rockhead.harness.evidence`). The Rust
...
from rockhead._schema.models import Evidence
from rockhead.harness import MODEL_REGISTRY_VERSION
from rockhead.harness.errors import NoModelMatch
from rockhead.harness.evidence import build_evidence
from rockhead.harness.model import DischargeRequest, Model
