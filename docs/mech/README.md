# mill -- Declarative Mechanical Design

> Spec 0.13 (unified). NAMED **mill** (`.mill`) in cycle 9 (D78).
...
mill is the mechanical instantiation of the substrate (`../substrate/`).
...
(`../implementation/`) build against. Naming (OPEN-10) is the one
open decision.
