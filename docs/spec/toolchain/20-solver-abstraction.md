...
attribution** in `docs/spec/regolith/13-invariants.md` in the SAME change
...
> DRAFT name -- ratified as **fluorite** (D93, `docs/spec/fluorite/`,
...
(`.fluo`; D93, `docs/spec/fluorite/`; implementation WO-31/WO-32). Item 7
...
6. **Fluid-circuit language home** (feldspar G25, reproduction case
   ...
   `docs/spec/fluorite/`) -- media/FluidPort/flownet language, the
...
new invariant (no `docs/spec/regolith/13-invariants.md` edit). Conformance
