...
> grammar landed ([02-language.md](02-language.md) sec. 10, [04-vocabulary.md](04-vocabulary.md)
> sec. I5).
...
| doc | contents |
|---|---|
| [01-overview.md](01-overview.md) | vision, scope, what is mech-specific vs inherited |
| [02-language.md](02-language.md) | parts, stages, setups, scopes, features, profiles, queries, datums |
| [03-contracts-and-assemblies.md](03-contracts-and-assemblies.md) | interfaces, impls, matings, assemblies, tolerances, fits, budgets |
| [04-vocabulary.md](04-vocabulary.md) | every keyword: position, meaning, lowering; retired list |
| [05-lowering.md](05-lowering.md) | the mech L0-L6 stack and the construct x level matrix |
| [06-roadmap.md](06-roadmap.md) | implementation phases A-E |
| [07-open-questions.md](07-open-questions.md) | OPEN / SEAM / watchlist, consolidated from all drafts |

Status: design phase, spec-complete as of 0.13 -- the technical open
queue is empty ([07-open-questions.md](07-open-questions.md); deferrals carry explicit
