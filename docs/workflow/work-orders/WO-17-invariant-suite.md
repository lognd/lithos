...
(regolith-syntax; `@`/`AtTok` lexed, statement-start dispatch, ../../spec/toolchain/grammar.ebnf
...
Language: both (placement per 00-architecture AD-11) -- see `../../spec/toolchain/00-architecture.md` (normative; supersedes Python-specific implementation notes below)
