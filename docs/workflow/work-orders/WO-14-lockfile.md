...
Language: Python (`regolith.orchestrator`; consumes Rust resolutions via WO-18) -- see `../../spec/toolchain/00-architecture.md` (normative; supersedes Python-specific implementation notes below)
