...
record), plus the soft W3 ask (`Prismatic` mating). Design-log D181
...
- `pla_class`: solid density 1240 kg/m3 + melting range 145-160C +
  ...
  model, not an independently fitted curve (D181's own rule). One
...
ledger, WO-64's ledger, and the D181 design-log addendum -- no
