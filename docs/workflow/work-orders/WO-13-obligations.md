...
Language: Rust (`regolith-oblig`; schemars export feeds WO-18) -- see `../../spec/toolchain/00-architecture.md` (normative; supersedes Python-specific implementation notes below)
