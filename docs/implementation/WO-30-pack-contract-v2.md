...
Spec: `20-solver-abstraction.md` sec. 8 (NORMATIVE for this WO:
...
3. **Given resolution + regimes (D97, sec. 8.4).** In
   ...
   `20-solver-abstraction.md` sec. 8.4 if any string is added --
...
6. **Docs.** `20-solver-abstraction.md` sec. 8 marked implemented;
