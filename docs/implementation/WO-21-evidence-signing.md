...
INV-22; design: `20-solver-abstraction.md` D-E/D-G, AD-20
...
- Orchestrator wiring: attach an attestation at discharge when a
  ...
  never accepted.
- **INV-28 ledger entry** in `docs/regolith/13-invariants.md` with
  the proof argument drafted in the design doc (D-G), plus its test
  column naming the fixtures below.
- Docs: harness doc section; `20-solver-abstraction.md` status flip.
