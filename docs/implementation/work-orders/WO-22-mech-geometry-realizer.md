...
recorded this cycle" and `../design/23-lowering-output-surface.md` sec. 5)
...
Full design writeup: `docs/implementation/design/22-mech-geometry-realizer.md`.
...
1. **Upstream blocker: no feature-program producer exists.** Checked
   ...
   charter `../design/23-lowering-output-surface.md`).
