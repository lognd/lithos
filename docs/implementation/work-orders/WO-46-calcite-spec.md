...
Spec: docs/calcite/01-charter.md (NORMATIVE, SETTLED), design-log
2026-07-08-cycle-26 D133; the fluorite track docs
(docs/fluorite/01..04) as the STRUCTURAL PATTERN to follow; the
...
`docs/calcite/` grows from charter to ratifiable track spec:
...
1. `docs/calcite/02-language.md`: the construct set per charter
   ...
   change.
2. `docs/calcite/03-lowering.md`: per-level table (charter sec. 5),
...
3. `docs/calcite/04-open-questions.md`: deferred items from charter
...
5. `docs/calcite/01-charter.md` gains a header note that 02/03/04
   now elaborate it; `docs/calcite/README.md` and `docs/README.md`
