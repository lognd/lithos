...
Spec: `../design/20-solver-abstraction.md` sec. 8 (NORMATIVE for this WO:
...
addressing); feldspar's halves: `../feldspar/docs/feldspar/06`
...
3. **Given resolution + regimes (D97, sec. 8.4).** In
   ...
   `../design/20-solver-abstraction.md` sec. 8.4 if any string is added --
...
6. **Docs.** `../design/20-solver-abstraction.md` sec. 8 marked implemented;
   regolith/07 sec. 2 coverage sentence updated to point at the
   structured encoding; `docs/regolith/13-invariants.md` NOT touched
