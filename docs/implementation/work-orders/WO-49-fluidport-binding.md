...
Spec: docs/fluorite/02-language.md (FluidPort, media),
docs/fluorite/04-open-questions.md FOPEN-1 (the deferral being
closed -- flip it in the same change), docs/hematite/02-language.md
