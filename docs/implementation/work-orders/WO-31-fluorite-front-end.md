...
Deliverables 3 (diagnostics), 4 (AD-23 net core cross-language elec
refit), 5 (example corpus), 6 (docs) remain NOT STARTED -- see the
wo31-cont branch report for the handoff)
