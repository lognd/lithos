...
/// `ConstraintsBlock` items (`rockhead_syntax::walk`): an item declares a
...
/// consumer (`rockhead_syntax::walk::parse_walk`) end-to-end into the DOF
...
mod corpus_tests {
    ...
    use rockhead_syntax::walk::parse_walk;
...
mod unit_tests {
    ...
    use rockhead_syntax::syntax_kind::SyntaxKind;
    use rockhead_syntax::walk::{parse_walk, Direction, Segment, Walk};
