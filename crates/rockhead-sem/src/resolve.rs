...
//! the syntactic L1 pass in `rockhead-syntax` can only decide it when an
...
use rockhead_diag::codes::EQUALITY_ON_CONTINUOUS;
use rockhead_diag::{Diagnostic, LabeledSpan, Span};
use rockhead_syntax::ast::{AstNode, Decl};
...
///
/// This is the complement of the syntactic pass in `rockhead-syntax`
...
mod tests {
    ...
    fn codes(src: &str) -> Vec<String> {
        ...
        let parse = rockhead_syntax::parse(src, &path);
