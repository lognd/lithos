...
//! 2. `LowerOutput` is the pure-Rust, no-IO shape `rockhead-api` wraps
//! into `BuildPayload` (AD-17).

use camino::Utf8PathBuf;
use rockhead_diag::Diagnostic;
use rockhead_oblig::{Evidence, Obligation, SnapshotRecord};
use rockhead_qty::Resolution;
use rockhead_syntax::Parse;
