...
//! sources.
//!
//! Regolith reference: `docs/spec/regolith/02-quantity-core.md` and
//! `docs/spec/regolith/03-value-sources.md`. Dimension exponents are
...
pub use log::{log_sum_reference, LogError, LogSumResult, LogTerm, LogUnit, Sign};
