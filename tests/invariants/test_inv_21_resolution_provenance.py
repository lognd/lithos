...
@pytest.mark.xfail(reason="WO-04 pending: INV-21 mechanism + fixture", strict=True)
def test_inv_21_primary_violation() -> None:
    """Deliberate INV-21 violation must be caught once WO-04 lands."""
    raise NotImplementedError(
        "STUB WO-17: INV-21 deliberate-violation fixture + assertion"
    )
